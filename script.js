...
let suma = num1 + num2;
    mostrarResultado('resultado-suma', "Resultado: " + suma);
}
...
let promedio = (prom1 + prom2 + prom3) / 3;
    mostrarResultado('resultado-promedio', "El promedio es: " + promedio);
}
...
let dias = anos * 365.25;
    mostrarResultado('resultado-edad', "Tu edad en dias es aproximadamente: " + dias)
